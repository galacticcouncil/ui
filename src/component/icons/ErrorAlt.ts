...
@customElement('uigc-icon-error-alt')
export class ErrorIconAlt extends BaseIcon {
  bsxTemplate() {
    return html`
  ...
  hdxTemplate() {
    return html` <svg hdx xmlns="http://www.w3.org/2000/svg" width="117" height="117" viewBox="0 0 117 117" fill="none">
