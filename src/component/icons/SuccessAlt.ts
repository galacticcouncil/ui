...
@customElement('uigc-icon-success-alt')
export class SuccessIconAlt extends BaseIcon {
  bsxTemplate() {
    return html`
  ...
  hdxTemplate() {
    return html` <svg hdx xmlns="http://www.w3.org/2000/svg" width="117" height="116" viewBox="0 0 117 116" fill="none">
